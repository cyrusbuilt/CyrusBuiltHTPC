/*
  ...
  though it has not been tested.  This is likely *NOT* compatible with the
...
#define VERSION "Raspi_ATX_PMU V1.7b"
...
// At that point, we switch off and update system state. Otherwise, we just
// process button events and cycle back around.
void loop() {
